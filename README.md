...
I think that we can debate all day about the "correct" way to construct the contrasts for testing. The whole point of this analysis though is to identify genes that have differing expression patterns across the groups of interest. Looking at the heatmaps in the manuscript, I think that we were able to do that; one can see clear differences. Overall, my outlook is this: we tried hard to be statistically rigorous in our methods and thought through how we were representing the data, which allowed us to identify some real differences, evidenced by visualization.
...
If interested, contact me for discussion. I have done a deep dive into this topic with supplementary plots that I can share.
